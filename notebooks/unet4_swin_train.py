...
train(model, loss, optimizer, train_dl, val_dl,
        ...
        save_path='../saved_models/unet_4_noshuflle/',
...
experiments = [
    (['layers_2', 'layers_3'], 1e-5)            # E: Unfreeze all
]
nr_of_epochs = 35
nr_of_epochs_save =  5
load_from_folders = ['swin_unfreeze2_2']
for i, (layers, lr) in enumerate(experiments, start=1):
    folder = f"swin_unfreeze3_{i}/"
